#!/usr/bin/env python3
"""Apply round2 SQL patch for missing columns."""
...
SQL_PATH = Path(__file__).resolve().parents[1] / "sql" / "patch_missing_columns_round2.sql"
...
def apply_with_sqlalchemy(sql: str):
    ...
    print("Applied round2 missing-columns patch via SQLAlchemy.")
    return True
